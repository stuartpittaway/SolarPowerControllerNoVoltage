...
#define NUMBER_OF_SAMPLES_PER_FULLWAVE 100
...
static volatile double sumP;

static volatile double filteredI,lastFilteredI;
...
//Fake sinewave spread over 1023 scale/100 readings
PROGMEM  prog_uint16_t sinetab[]  = {	512,	544,	576,	608,	639,
	670,	700,	730,	759,	786,	813,	838,	862,	885,
	906,	926,	944,	960,	975,	988,	999,	1007,	1014,
	1019,	1022,	1023,	1022,	1019,	1014,	1006,	997,	986,
	973,	958,	942,	924,	904,	882,	859,	835,	809,
	783,	755,	726,	696,	666,	635,	603,	572,	539,
	507,	475,	443,	411,	380,	349,	319,	289,	261,
	233,	207,	181,	157,	135,	114,	94,	77,	61,
	46,	34,	23,	15,	8,	3,	1,	0,	1,
	5,	10,	18,	27,	39,	52,	67,	84,	102,
	122,	144,	167,	191,	217,	244,	272,	301,	331,
	361,	392,	424,	456,	488,	};
...
static void takesinglereading() {
  ...
  instP = filteredV * filteredI; //  power contribution for this pair of V&I samples 
